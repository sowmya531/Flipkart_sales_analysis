...
3. Which brands consistently achieve the highest average customer ratings (considering brands with at least 5 products)?
Analysis:-
...
6. Highest discount product in each category.
7. Products ranked by sales using Window Functions.
8. Top-rated products.
9. Category-wise sales analysis.
10. Products with the highest revenue contribution.
...
3. Open the `SQL_Queries.sql` file.
